...
{
    public partial class PointForm : System.Windows.Forms.Form
    {
                ...
                new FileStream(dlg.FileName, FileMode.Create, FileAccess.Write))
            {
                switch (Path.GetExtension(dlg.FileName))
                {
                    ...
                    case ".soap":
                        ...
                        break;
                    case ".xml":
                        XmlRootAttribute xmlAnyAttribute = new XmlRootAttribute("Points");
                        XmlAttributeOverrides xmlAtributeOverrides = new XmlAttributeOverrides();
                        
                        var xf = new XmlSerializer(typeof(Point[]), xmlAtributeOverrides, new[] { typeof(Point3D) },
                            xmlAnyAttribute, "Points");
